#include "KEngine.h"
#include "andariel_special_cast_overlay.h"
...
void K::AndarielSpecialCastOverlay::Initialize()
{
	try
	{
	...
	{
		std::cout << "AndarielSpecialCastOverlay::Initialize" << std::endl;
	}
}

K::APTR K::AndarielSpecialCastOverlay::Clone() const
{
	return APTR{ new AndarielSpecialCastOverlay{ *this }, [](AndarielSpecialCastOverlay* _p) {
		_p->_Finalize();
		delete _p;
	} };
}

void K::AndarielSpecialCastOverlay::Serialize(InputMemoryStream& _imstream)
{
}

void K::AndarielSpecialCastOverlay::Serialize(OutputMemoryStream& _omstream)
{
}

K::AndarielSpecialCastOverlay::AndarielSpecialCastOverlay(AndarielSpecialCastOverlay const& _other) : MissileActor(_other)
{
}

K::AndarielSpecialCastOverlay::AndarielSpecialCastOverlay(AndarielSpecialCastOverlay&& _other) noexcept : MissileActor(std::move(_other))
{
}

void K::AndarielSpecialCastOverlay::_Finalize()
{
}
